...
class StockViewUserPage extends StatefulWidget {
  const StockViewUserPage({super.key, required this.title});

  final String title;

  @override
  State<StockViewUserPage> createState() => _StockViewUserPageState();
}

class _StockViewUserPageState extends State<StockViewUserPage> {
